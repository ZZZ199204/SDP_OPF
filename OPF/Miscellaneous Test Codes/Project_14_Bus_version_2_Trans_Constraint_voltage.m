...
cvx_begin sdp
variables lambdak_m(14) lambdak_M(14)  lambda_k_m(14) lambda_k_M(14) mu_k_M(14) mu_k_m(14) lambda_lm(c) mu_lm(c);
...
disp(mu_k_m);
fprintf('\nLagrange Multiplier of voltage difference limit constraints\n');
disp(mu_lm);
