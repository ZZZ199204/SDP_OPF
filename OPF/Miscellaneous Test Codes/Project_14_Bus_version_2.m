...
Yline_G=xlsread('Copy of 14bus.xlsm', 3, 'B2:O15');
Yline_B=xlsread('Copy of 14bus.xlsm', 1, 'B2:O15');
Yshunt_B=xlsread('Copy of 14bus.xlsm', 2, 'B2:O15');
Yconn=xlsread('Copy of 14bus.xlsm', 4, 'B2:O15');
disp(Yline_G);
disp(Yline_B);
disp(Yshunt_B);
disp(Yconn);
